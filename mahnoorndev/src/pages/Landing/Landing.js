  ...
  return (
    <div className="home">
      <HeaderHome
        ...
        subtitle="Applications for 2024 Scholarships are now open"
        ...
        <div className="about-msf">
          ...
          <div className="about-msf-section">
            ...
            <p style={{ color: "#808080" }}>
              ...
              and University students who are eager to make an impact, learn and
      ...
      <div className="bottomNavigation">
        ...
        <button
          href="https://github.com/bill-ahmed/SpendingTracker"
          target="_blank"
          variant="text"
          color="inherit"
        >
